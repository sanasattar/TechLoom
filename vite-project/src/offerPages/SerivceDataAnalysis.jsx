...
// import dataQuality from "../assets/dataQuality.jpg"; // Replace with your image
// import advancedAnalytics from "../assets/advancedAnalytics.jpg"; // Replace with your image
// import dataVisualization from "../assets/dataVisualization.jpg"; // Replace with your image
      ...
      <div className="relative h-screen w-full">
        ...
        <div className="absolute inset-0 flex items-center px-10 z-10 mb-80">
          <ul className="list-disc flex flex-wrap justify-center gap-6 md:gap-16 text-white text-lg md:text-2xl font-bold">
            ...
            <li className="text-[#29A8AB]">
              <Link to="/service/dataanalysis/servicedataanalysis">
                Data Analysis
              </Link>
            </li>
          </ul>
      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-2/3 p-6 md:p-10">
          ...
          <p className="text-sm leading-8 md:text-lg md:leading-10">
            Our Data Analysis solutions are designed to help you make informed decisions by providing powerful insights into your data. We utilize cutting-edge technologies to process and interpret data, turning complex information into actionable results.
          </p>

          <div className="pt-6">
            <img
              className="w-full h-80 rounded-2xl"
              // src={dataQuality} // Replace with your image
            ...
            {[
              {
                ...
                // img: dataQuality,
                description:
                  "Ensuring that your data is accurate, consistent, and reliable.",
              },
              {
                title: "Advanced Analytics",
                // img: advancedAnalytics,
                description:
                  "Leveraging advanced algorithms and machine learning to uncover insights.",
              },
              {
                title: "Visualization",
                // img: dataVisualization,
                description:
                  "Making data more accessible with clear and actionable visualizations.",
              },
            ].map((service, index) => (
              <Link
                key={index}
      ...
      <div className="py-16 px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            {
              title: "Python",
              desc: "For data analysis and machine learning.",
            },
            {
              title: "R",
              desc: "Specialized tools for statistical analysis.",
            },
            {
              title: "SQL",
              desc: "For database querying and management.",
            },
            {
              title: "Tableau",
              desc: "For data visualization and business intelligence.",
            },
          ].map((tool, index) => (
            <div key={index} className="bg-white p-6 rounded-lg shadow-lg">
              <h3 className="text-xl font-semibold text-gray-800 mb-3">
...
export default ServiceDataAnalysis;