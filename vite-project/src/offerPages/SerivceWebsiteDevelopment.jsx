...
import responsiveDesign from "../assets/responsivedesign.webp"; // Replace with your image for responsive design
import ecommerce from "../assets/ecommerce.png"; // Replace with your image for e-commerce
// import cms from "../assets/cms.png";



const SerivceWebsiteDevelopment = () => {
      ...
      <div className="relative h-screen w-full">
        ...
        <div className="absolute inset-0 flex items-center px-10 z-10 mb-80">
          <ul className="list-disc flex flex-wrap justify-center gap-6 md:gap-16 text-white text-lg md:text-2xl font-bold">
            ...
            <li className="text-[#29A8AB]">
              <Link to="/service/webdevelopment/servicewebdevelopment">
                Web Development
              </Link>
            </li>
          </ul>
      ...
      <div className="flex flex-col md:flex-row">
        <div className="w-full md:w-2/3 p-6 md:p-10">
          ...
          <p className="text-base md:text-lg">
            We specialize in creating modern, responsive, and user-friendly websites tailored to your business needs. Our web development services include custom website design, e-commerce solutions, content management systems (CMS), and more.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
            {[
              { title: "Responsive Design", img: responsiveDesign },
              { title: "E-Commerce Solutions", img: ecommerce },
              // { title: "CMS Development", img: cms },
            ].map((service, index) => (
              <Link
                key={index}
                to={service.link}
      ...
      <div className="bg-gray-100 py-16 px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            {
              title: "Quality",
              desc: "We ensure the highest quality in every website we develop.",
            },
            {
              title: "Innovation",
              desc: "We use the latest technologies to create innovative web solutions.",
            },
            {
...
export default SerivceWebsiteDevelopment
